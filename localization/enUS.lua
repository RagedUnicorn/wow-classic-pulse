...
rgp.L["move"] = "|cFFFFC300move|r - place the energy bar on screen"
...
rgp.L["snap_energy_bar_to_grid"] = "Snap to Grid"
rgp.L["snap_energy_bar_to_grid_tooltip"] = "Aligns the energy bar to a grid when you drop it"
rgp.L["energy_bar_grid_size"] = "Grid Size"
rgp.L["energy_bar_grid_size_tooltip"] = "Spacing of the alignment grid in pixels"
rgp.L["move_bar"] = "Move Bar"
rgp.L["move_bar_description"] = "Closes these options so you can drag the energy bar into place"
rgp.L["positioning_hud_instruction"] = "Drag the energy bar to position it"
rgp.L["positioning_hud_instruction_snap"] =
  "Drag the energy bar to position it. Its top left corner snaps to the grid."
rgp.L["positioning_hud_done"] = "Done"
